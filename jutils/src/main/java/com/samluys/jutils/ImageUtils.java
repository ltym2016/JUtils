...
public class ImageUtils {
    ...
    public static class Config {
        ...
        public static final int LONG_IMAGE_RATIO = 4;//长图，宽图比例基准

        public static final int MAX_LONG_IMG_HEIGHT = 15000;//长图长度上限
    ...
    public static String compressImage(String inputFile, String outputDir, int options, int customMaxSize) {
        ...
        if (BitmapUtils.getImageMineType(inputFile) == BitmapUtils.ImageType.TYPE_GIF) {
            if (StringUtils.isContainChinese(inputFile)) {
                String destPath = outputDir + System.currentTimeMillis() + "comp.gif";
                FileUtils.copy(new File(inputFile), new File(destPath));
